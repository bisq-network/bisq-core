...
public class NonBsqCoinSelector extends BisqDefaultCoinSelector {
    ...
    @Inject
    public NonBsqCoinSelector(StateService stateService) {
        super(true);
    ...
    protected boolean isTxOutputSpendable(TransactionOutput output) {
        ...
        boolean outputIsNotInBsqState = !stateService.existsTxOutput(key);
        return outputIsNotInBsqState || stateService.getBtcTxOutput(key).isPresent();
    }
}
