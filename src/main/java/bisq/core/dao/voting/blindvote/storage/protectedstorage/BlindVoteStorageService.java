...
@Slf4j
public class BlindVoteStorageService extends StoreService<BlindVoteStore, ProtectedStorageEntry> {
    ...
    public boolean canHandle(ProtectedStorageEntry entry) {
        return entry.getProtectedStoragePayload() instanceof BlindVotePayload;
    }
